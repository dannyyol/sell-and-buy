              ...
              @else
                    ...
                    {{-- <ul class="navbar-nav">
                      <li class="nav-item dropdown profile_pic" style="">
                        ...
                        <li class="large_register authentication_sm_hide" style="font-size:0.9em;">
                          <a class="nav-link btn btn-success" href="{{ route('register') }}" style="color:#fff;font-size:0.8em;"><i class="fa fa-ad"></i> Post Advert</a>
                        </li>
