    ...
    <div class="sidebar-header">
        {{-- <h3>Bootstrap Sidebar</h3> --}}
          ...
          @if (!Auth::guest())
            ...
            @endif
            <div class="d-flex justify-content-center">Hi {{Auth::user()->name}}
        ...
        {{-- end notification --}}
          ...
          <li>
              ...
              <ul class="collapse list-unstyled" id="pageSubmenu">
                  ...
                  @else
                    <a href="{{route('login')}}"  style="margin-top:0px;">Create Advert</a>
                  @endif
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg bg-light navbar-bg fixed-top">
              ...
              @else
                    ...
                    {{-- <ul class="navbar-nav">
                      <li class="nav-item dropdown profile_pic" style="">
                        ...
                        <li class="large_register authentication_sm_hide" style="font-size:12px;">
                          <a class="nav-link btn btn-success" href="{{ route('register') }}" style="color:#fff;font-size:12px;"><i class="fa fa-ad"></i> Post Advert</a>
                        </li>

                        {{-- <h5 style="color:rgb(105,105,105);margin-right:10px;">Bootstrap Sidebar</h5> --}}
              ...
              <div class="col-lg-12">
                  <div class="row">
                      <div class="col-lg-3 col-md-3 col-sm-4 select_box p-0">
                          <select class="form-control search-slt" id="formcontrol1" name="" onchange="location = this.value;">
                            <option>Choose Schools Forum</option>
                            @foreach ($schools as $school)
                              <option value="{{ route('school.show_frontend', ['id'=>$school->id, 'school'=>$school->slug]) }}">{{ $school->name }}</option>
                            @endforeach
  ...
  {{-- comment          <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-5 search_box p-0">
                          <input type="text" class="form-control search-slt" id ='formcontrol2' placeholder="Enter Advert" name="q">
                      </div>
